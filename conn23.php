...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO college2023 (college_code, college, city, branch, gopen, lopen, gobc, lobc, gsc, lsc, gst, lst, gnt, lnt, pwd, ews, mi, lowest_package, median_package, highest_package) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        header("Location: college2023.php");
        exit();
    } else {
